...
// Enhanced Batik Pattern Component
const BatikPattern = ({ className = "" }: { className?: string }) => {
  ...
  return (
    ...
    >
      <defs>
        <pattern id="batik-pattern-istilah-enhanced" x="0" y="0" width="150" height="150" patternUnits="userSpaceOnUse">
      ...
      <rect width="100%" height="100%" fill="url(#batik-pattern-istilah-enhanced)" />
    </svg>
  )
}
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-center text-gray-600 mb-6">
            Menyiapkan pengalaman visual interaktif
          </p>
