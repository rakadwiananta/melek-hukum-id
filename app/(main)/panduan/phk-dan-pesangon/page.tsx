      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 mb-12 border-2 border-purple-200">
          ...
          <div className="text-center">
            <Link 
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-2xl hover:shadow-xl transform hover:scale-105 transition-all"
            >
        ...
        <div className="text-center bg-gradient-to-r from-red-100 to-orange-100 rounded-3xl p-10 shadow-xl">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link 
              href="/konsultasi/ketenagakerjaan"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-red-600 font-semibold rounded-2xl border-2 border-red-600 hover:bg-red-50 transition-all"
            >
