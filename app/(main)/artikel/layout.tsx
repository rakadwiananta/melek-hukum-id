...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Tim Melek Hukum ID' }],
  ...
  openGraph: {
    ...
    url: 'https://melekhukum.id/artikel',
    siteName: 'Melek Hukum ID',
    images: [
      {
        url: 'https://melekhukum.id/images/og-artikel.jpg',
        width: 1200,
        height: 630,
        alt: 'Melek Hukum ID - Portal Hukum Indonesia',
      },
    ],
    locale: 'id_ID',
    type: 'website',
  ...
  twitter: {
    ...
    images: ['https://melekhukum.id/images/twitter-artikel.jpg'],
  },
  robots: {
    index: true,
    follow: true,
